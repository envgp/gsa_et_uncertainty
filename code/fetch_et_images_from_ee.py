...
ds = xr.open_mfdataset("../data/et_images_wyandotte_2/openetbitmask/*.nc")
...
ds.to_netcdf("../data/et_images/et_images_wyandotte/wyandotte_openet_images_2.nc")
...
make_dirs = True
base_output_dir = "../data/et_images_wyandotte_2"
...
for image_key in image_dict.keys():
    ...
    shp = cv_shape
    shp_2 = gsa_cv_cleaned_no_small[gsa_cv_cleaned_no_small["GSP_ID"] == gsa_id]

    area = shp.area * 1e-6
    shp_degree = shp.to_crs(4326)
    shp_degree_2 = shp_2.to_crs(4326)
    ...
    image_array_clipped = image_array.rio.clip(
        shp_degree_2.geometry.apply(mapping), shp_degree.crs, drop=True
    )
