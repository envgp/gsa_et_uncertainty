...
# -*- coding: utf-8 -*-
"""
Created on Sat May 20 08:55:05 2023
...
image_names = ["soil_moisture"]
image_locations = [ee.ImageCollection("NASA_USDA/HSL/SMAP10KM_soil_moisture")]
image_variables = [["ssm", "susm"]]
image_dict = {}
...
#        )
image = (
    image_locations[0].select(image_variables[0]).filterDate("2015-01-01", "2022-01-01")
)
...
for j in range(1, 5):
    ...
    for i in range(1, 5):
        ...
        image_array = image.wx.to_xarray(
            ...
            + "soil_moisture_2015_2020_{i}_{j}.nc".format(i=i, j=j),
            scale=10000,
        )
